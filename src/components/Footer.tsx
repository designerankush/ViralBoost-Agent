  ...
  return (
    <footer className="border-t border-gray-800 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* CTA Section */}
        <div className="text-center mb-16 p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-violet-600/20 via-fuchsia-600/20 to-pink-600/20 border border-violet-500/20 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              AI-powered organic social media growth. No ads. No gimmicks. Just results.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            © 2026 ViralBoost AI. All rights reserved.
          </p>
